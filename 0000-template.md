...
> There are a lot of ways Chocola may be used. It may be hosted on different platforms;
> integrated with different libraries; built with different bundlers, etc. No one
> person knows everything about all the ways Chocola may be used. What does someone who
> knows about Chocola but hasn't necessarily used anything outside of it need to
...
> designs or make them better fit Chocola.
...
idea best presented? As a continuation of existing Chocola patterns, or as a
wholly new one?

> Would the acceptance of this proposal mean the Chocola guides must be
re-organized or altered? Does it change how Chocola is taught to new users
at any level?

> How should this feature be introduced and taught to existing Chocola
users?

## Drawbacks

> Why should we *not* do this? Please consider the impact on teaching Chocola,
